...
urlpatterns = [
    ...
    path('requests/<int:pk>/student_response/', views.respond_to_lecturer_response, name='student-response'),
    ...
    path('student_requests/<int:pk>/accept', views.accept_studentRequest, name='request-accept'),
